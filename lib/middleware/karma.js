    ...
    if (requestUrl === '/context.html' || requestUrl === '/debug.html') {
      return filesPromise.then(function(files) {
        serveStaticFile(requestUrl, response, function(data) {
          ...
          var filesToServe = files.parallelServedIndex !== undefined ?  files.servedParallel[files.parallelServedIndex++] : files.served;

          // TODO(vojta): don't compute if it's not in the template
          var mappings = filesToServe.map(function(file) {
